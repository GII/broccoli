 ...
 * @version 1
 */
public class AttributeSimpleParser extends XMLDOMElementParser
{

    public AttributeSimpleParser(String syntaxName, BSDLRegistry bsdlRegistry)
    {
        super(syntaxName, bsdlRegistry, Node.ATTRIBUTE_NODE);
    }
    ...
    {
        return new SimpleProperty(name(), node.getNode().getNodeValue());
    }
