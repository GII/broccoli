 ...
 * 
 */
public class PropertyMultiplicityParser extends XMLStAXElementParser {
    

    public PropertyMultiplicityParser(BSDLRegistry bsdlRegistry) {
        super(XMLSyntax.MULTIPLICITY(), bsdlRegistry);
    }
    ...
    public IElementParser newInstance() {
        return new PropertyMultiplicityParser(this.bsdlRegistry);
    }
