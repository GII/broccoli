...
/**
 *  Implementations must handle the specifics of a type of grounding for 
 * OWL-S atomic services using OWLSAPI
 *  
 * 
 */
public interface IOWLSDynamicGrounding extends IFunctionalityGrounding {
