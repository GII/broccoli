...
/**
 *  A basic IComponents registry. Intented for both service-provider and
 * client-side kind of components, even components that have both roles.
 * 
 * 
 */
public interface IComponentsRegistry {
    ...
    public boolean registerComponent (IComponent component) throws BSDMComponentException;
    
    public boolean unregisterComponent (IComponent component) throws BSDMComponentException;
