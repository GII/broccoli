 ...
 * 
 */
public interface IServiceFunctionality extends IFunctionality, IExecutableFunctionality, IComponent
{

    public Collection<IFunctionalityGrounding> getFunctionalityGroundings();

    public void setFunctionalityGrounding(IFunctionalityGrounding functionalityGrounding) throws ModelException;
