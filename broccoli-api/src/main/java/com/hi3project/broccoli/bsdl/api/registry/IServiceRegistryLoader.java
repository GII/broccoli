 ...
 * 
 */
public interface IServiceRegistryLoader extends IServiceDescriptionLoader
{
       
    public IServiceRegistry getServiceRegistry();
    
    Collection<IFunctionalitySearchResult> searchForFunctionalitiesFrom(ISemanticLocator locator) throws ModelException;
    
    Collection<IFunctionalitySearchResult> searchForFunctionalitiesFrom(Collection<ISemanticLocator> locators) throws ModelException;
